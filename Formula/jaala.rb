class Jaala < Formula
  ...
  url "file://#{__dir__}/../dist/jaala-0.2.4.tar.gz"
  sha256 "c42e528c46c25a4188356d3f68f4bf3ba9591cfbf93ff6621719387bdf9af1a0"
  license "MIT"
  ...
  test do
    assert_match "jaala 0.2.4", shell_output("#{bin}/jaala --version")
  end
end
